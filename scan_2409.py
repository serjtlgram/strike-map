...
async def main():
    ...
    # 24.09.2026 from 00:00 to 24:00 (local MSK/Kyiv is UTC+3, so UTC is 23.09 21:00 to 24.09 21:00)
    # Scan from 23.09 18:00 UTC to 25.09 03:00 UTC
    start_utc = datetime(2026, 9, 23, 18, 0, 0, tzinfo=timezone.utc)
    end_utc = datetime(2026, 9, 25, 3, 0, 0, tzinfo=timezone.utc)

    out_file = BASE_DIR / 'dump_2409.txt'
