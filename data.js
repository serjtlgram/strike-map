const strikeData = [
  ...
  },
  {
    ...
    "ru": {
      ...
      "category": "НПЗ",
      "weapon": "Дрон",
      "details": "«Славнефть-ЯНОС» — один из старейших и крупнейших НПЗ России, работающий с 1961 года. Мощность переработки превышает 15 млн тонн нефти в год (~3–4% всей российской нефтепереработки). Завод производит бензин, дизельное и реактивное топливо, мазут и нефтехимическое сырьё и является ключевым поставщиком топлива для московского региона. Утром 16 июля 2026 года украинские ударные БПЛА дальнего радиуса поразили товарно-сырьевой резервуарный парк завода; OSINT-аналитики зафиксировали попадание и сильное задымление над объектом. Губернатор Ярославской области Евраев подтвердил атаку: 19 дронов перехвачено ПВО, но часть всё же достигла цели. Один местный житель погиб, четверо ранены; трасса Ярославль–Москва была временно закрыта, а работа аэропорта — ограничена. Это не первая атака на «ЯНОС» в 2026 году — завод стал регулярной целью украинских глубоких ударов.",
    ...
    "uk": {
      ...
      "category": "НПЗ",
      "weapon": "Дрон",
      "details": "«Славнефть-ЯНОС» — один із найстаріших та найбільших НПЗ Росії, що працює з 1961 року. Потужність переробки перевищує 15 млн тонн нафти на рік (~3–4% усієї російської нафтопереробки). Завод виробляє бензин, дизельне та реактивне паливо, мазут і нафтохімічну сировину та є ключовим постачальником палива для московського регіону. Вранці 16 липня 2026 року українські ударні БПЛА далекого радіусу уразили товарно-сировинний резервуарний парк заводу; OSINT-аналітики зафіксували влучання і сильне задимлення над об'єктом. Губернатор Ярославської області Євраєв підтвердив атаку: 19 дронів перехоплено ППО, але частина все ж досягла мети. Один місцевий житель загинув, четверо поранені; траса Ярославль–Москва була тимчасово закрита, а робота аеропорту — обмежена. Це не перша атака на «ЯНОС» у 2026 році — завод став регулярною ціллю українських глибоких ударів.",
  ...
  },
  {
    ...
    "ru": {
      ...
      "category": "Нефтегаз",
      "weapon": "Дрон",
      "details": "Ильский НПЗ им. А.А. Шамара (КНГК-ИНПЗ) — один из крупнейших нефтеперерабатывающих заводов Юга России мощностью 6,6 млн тонн нефти в год. Объект занимает стратегическое положение вблизи черноморских и азовских портов Новороссийск, Туапсе, Темрюк, через которые осуществляется экспорт нефтепродуктов. В ночь на 10 июля ударные БПЛА атаковали завод, при этом в зону возгорания попала установка АВТ-6 — крупнейшая установка первичной переработки нефти мощностью 3,6 млн тонн в год, обеспечивающая 56% общего объёма переработки НПЗ. Также зафиксированы повреждения трубопроводов и возгорания вблизи установок АТ-2 и АТ-3. ГУР МО и Генштаб ВСУ подтвердили успешный удар, подчеркнув ключевую роль объекта в снабжении топливом российских войск на юге.",
