const strikeData = [
  ...
  },
  {
    ...
    "distance": 520,
    "ru": {
      "region": "Волгоградская область, район Котово",
      "target": "Нефтеперекачивающий и нефтеперерабатывающий узел",
      "category": "Нефтегаз",
      "weapon": "Дрон",
      "details": "Поражен объект обработки, транспортировки и перекачки нефти. Генштаб ВСУ сообщил о пожаре на объекте нефтяной инфраструктуры.",
      "source": "Генштаб ВСУ, Reuters"
    },
    "uk": {
      "region": "Волгоградська область, район Котово",
      "target": "Нафтоперекачувальний та нафтопереробний вузол",
      "category": "Нафтогаз",
      "weapon": "Дрон",
      "details": "Уражено об'єкт обробки, транспортування та перекачування нафти. Генштаб ЗСУ повідомив про пожежу на об'єкті нафтової інфраструктури.",
