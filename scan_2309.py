...
async def main():
    ...
    # 23.09.2026 from 00:00 to 24:00 (local MSK/Kyiv is UTC+3, so UTC is 22.09 21:00 to 23.09 21:00)
    # Scan from 22.09 18:00 UTC to 24.09 18:00 UTC
    start_utc = datetime(2026, 9, 22, 18, 0, 0, tzinfo=timezone.utc)
    end_utc = datetime(2026, 9, 24, 18, 0, 0, tzinfo=timezone.utc)

    out_file = BASE_DIR / 'dump_2309.txt'
