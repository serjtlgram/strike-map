...
async def main():
    ...
    # 21.09.2026 from 00:00 to 24:00 (local MSK/Kyiv is UTC+3, so UTC is 20.09 21:00 to 21.09 21:00)
    # Scan slightly wider: 20.09 18:00 UTC to 22.09 03:00 UTC
    start_utc = datetime(2026, 9, 20, 18, 0, 0, tzinfo=timezone.utc)
    end_utc = datetime(2026, 9, 22, 3, 0, 0, tzinfo=timezone.utc)

    out_file = BASE_DIR / 'dump_2109.txt'
