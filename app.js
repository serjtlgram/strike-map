document.addEventListener('DOMContentLoaded', () => {
    ...
    const refineriesList = [
        ...
        { id: 'kinef', name: { ru: 'Киришский НПЗ (КИНЕФ)', uk: 'Кіриський НПЗ (КІНЕФ)', en: 'Kirishi Refinery (KINEF)' }, company: 'Сургутнефтегаз', region: { ru: 'Ленинградская обл., Кириши', uk: 'Ленінградська обл., Кіриші', en: 'Leningrad Oblast, Kirishi' }, capacity: 20.1, query: ['кириш', 'кинеф'], opStatus: 'halted', lat: 59.4894, lng: 32.0625 },
        ...
        { id: 'taneko', name: { ru: 'ТАНЕКО', uk: 'ТАНЕКО', en: 'TANECO Refinery' }, company: 'Татнефть', region: { ru: 'Татарстан, Нижнекамск', uk: 'Татарстан, Нижньокамськ', en: 'Tatarstan, Nizhnekamsk' }, capacity: 16.2, query: ['танеко'], opStatus: 'halted', lat: 55.5786, lng: 51.9365 },
        { id: 'yanos', name: { ru: 'Славнефть-ЯНОС', uk: 'Славнафта-ЯНОС', en: 'Slavneft-YANOS' }, company: 'Славнефть', region: { ru: 'Ярославская обл., Ярославль', uk: 'Ярославська обл., Ярославль', en: 'Yaroslavl Oblast, Yaroslavl' }, capacity: 15.0, query: ['янос', 'ново-ярославский', 'ярославский нпз'], opStatus: 'halted', lat: 57.6012, lng: 39.8745 },
        ...
        { id: 'perm', name: { ru: 'Пермнефтеоргсинтез', uk: 'Пермнафтооргсинтез', en: 'Perm Refinery' }, company: 'Лукойл', region: { ru: 'Пермский край, Пермь', uk: 'Пермський край, Перм', en: 'Perm Krai, Perm' }, capacity: 13.1, query: ['пермнефтеоргсинтез', 'лукойл-пермнефте'], opStatus: 'halted', lat: 57.915, lng: 56.175 },
        { id: 'moscow', name: { ru: 'Московский НПЗ (МНПЗ)', uk: 'Московський НПЗ (МНПЗ)', en: 'Moscow Refinery' }, company: 'Газпромнефть', region: { ru: 'Москва, Капотня', uk: 'Москва, Капотня', en: 'Moscow, Kapotnya' }, capacity: 12.1, query: ['московский нпз', 'мнпз'], opStatus: 'halted', lat: 55.6536, lng: 37.8078 },
        ...
        { id: 'kuibyshev', name: { ru: 'Куйбышевский НПЗ', uk: 'Куйбишевський НПЗ', en: 'Kuibyshev Refinery' }, company: 'Роснефть', region: { ru: 'Самарская обл., Самара', uk: 'Самарська обл., Самара', en: 'Samara Oblast, Samara' }, capacity: 7.0, query: ['куйбышевский нпз', 'кнпз', 'куйбышевский нефтеперерабатывающий'], opStatus: 'halted', lat: 53.1001, lng: 50.0510 },
    ...
    const ozonWarehousesList = [
        ...
        { id: 'ozon_sofino', ru: { name: 'Софьино / Жуковский', region: 'Московская обл., Раменский р-н', desc: 'Крупнейший распределительный центр Ozon' }, uk: { name: 'Соф\'їно / Жуковський', region: 'Московська обл., Раменський р-н', desc: 'Найбільший розподільчий центр Ozon' }, en: { name: 'Sofino / Zhukovsky', region: 'Moscow Oblast, Ramensky District', desc: 'Major Ozon distribution center' }, area: 100000, lat: 55.505, lng: 38.165, queryTerms: ['софьино', 'sofino'], opStatus: 'halted' },
        ...
        { id: 'ozon_taganrog', ru: { name: 'Таганрог (Поляковское ш.)', region: 'Ростовская обл., Таганрог', desc: 'Логистический комплекс / распределительный центр Ozon' }, uk: { name: 'Таганрог (Поляковське ш.)', region: 'Ростовська обл., Таганрог', desc: 'Логістичний комплекс / розподільчий центр Ozon' }, en: { name: 'Taganrog (Polyakovskoe hwy)', region: 'Rostov Oblast, Taganrog', desc: 'Ozon logistics and distribution center in Taganrog' }, area: 25000, lat: 47.2547, lng: 38.8689, queryTerms: ['таганрог', 'taganrog'], opStatus: 'halted' }
    ];
