...
async def main():
    ...
    # 22.09.2026 from 00:00 to 24:00 (local MSK/Kyiv is UTC+3, so UTC is 21.09 21:00 to 22.09 21:00)
    # Scan from 21.09 18:00 UTC to 23.09 09:00 UTC
    start_utc = datetime(2026, 9, 21, 18, 0, 0, tzinfo=timezone.utc)
    end_utc = datetime(2026, 9, 23, 9, 0, 0, tzinfo=timezone.utc)

    out_file = BASE_DIR / 'dump_2209.txt'
