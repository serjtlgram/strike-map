...
async def main():
    ...
    channels = [
        ...
        'DIUkraine', 'SBUkr', 'bazabazon', 'shot_shot', 'mash', 'dnipro_osint', 'combat_ftg',
        'WarZoneInc', 'dosye_shpiona', 'milinfolive', 'readovkanews'
    ]
    # 20.09.2026 from 00:00 to 24:00 (local MSK/Kyiv is UTC+3, so UTC is 19.09 21:00 to 20.09 21:00)
    # Scan slightly wider: 19.09 20:00 UTC to 21.09 00:00 UTC
    start_utc = datetime(2026, 9, 19, 20, 0, 0, tzinfo=timezone.utc)
    end_utc = datetime(2026, 9, 21, 0, 0, 0, tzinfo=timezone.utc)

    out_file = BASE_DIR / 'dump_2009.txt'
